...
//	        	ReportActionUtils.setDepartmentsForCurrentUser(request, WPC.INCLUDE_SUBORDINATE, false, true);
        	...
        	ReportActionUtils.setFileReportInRequest(request, "duration_stages");
            forward = mapping.findForward("success");      	
        } catch (Exception e) {
        	logger.log(Level.SEVERE, "Ошибка при формировании отчета 'сроки прохождения этапов'", e);
            e.printStackTrace();
