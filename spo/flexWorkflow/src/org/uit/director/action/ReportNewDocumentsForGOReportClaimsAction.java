 ...
 */
public class ReportNewDocumentsForGOReportClaimsAction extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        logger.info("Вызов отчета 'Перечень недоставленных в ГО документов, прикрепленных в филиалах, по заявкам'");
        ...
        String sFile = path + "Audit/new_documents_for_go_by_oders.rptdesign";
