...
// ---- Common Options ----
var gMonths=["Январь","Февраль","Март","Апрель","Май","Июнь","Июль","Август","Сентябрь","Октябрь","Ноябрь","Декабрь"];
//var gWeekDay=["Su","Mo","Tu","We","Th","Fr","Sa"];	// weekday caption from Sunday to Saturday
var gWeekDay=["Вс","Пн","Вт","Ср","Чт","Пт","Сб"];
...
var gsOutOfRange="Дата не входит в заданный период!";	// Sorry, you may not go beyond the designated range! - out-of-date-range error message. If set to "", no alerts will popup on such error.
