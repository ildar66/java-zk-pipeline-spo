 ...
 * @author pmasalov
 */
public enum GridTopOtherItem implements GridColumnItem {
    NN("#", null, "nn", true, null, null, true),
    // Основные аттрибуты
    MDTASK_NUMBER("№ версия заявки", null, "mdtaskNumber", true, null, null, false),
    ...
    PRODUCT_NAME("Вид сделки", null, "productName", true, null, null, true),
    ...
    MARGIN("Маржа", UnitOfMeasure.PERCENT, "margin", false, null, null, true, true),
    LOAN_RATE("Ставка фондирования", UnitOfMeasure.PERCENT, "loanRate", false, null, null, true, true),
    ...
    TRADE_DESK("Трейдинг Деск", null, "tradeDesc", false, null, null, true),
    ...
    FIX_DATE("Плановая дата подписания КОД", null, "proposedDtSigning", false, null, Formats.DATE_FORMAT, true),
    INDUSTRY("Отрасль", null, "industry", false, null, null, true),
    ...
    USE_PERIOD_MONTH("Срок использования", UnitOfMeasure.TERM_MONTH, "usePeriodMonth", false, null, null, true, true),
    RATE("% ставка", null, "rate", false, null, null, true, true),
    ...
    WAL("Средневзвешенный срок сделки (WAL)", UnitOfMeasure.TERM_MONTH, "wal", false, null, null, true, true),
    LINE_COUNT_RUB("Выбранный объем линии", UnitOfMeasure.MLN_RUB, "lineCountRub", false, null, null, true, true),
    AVAILABLE_LINE_VOLUME_RUB("Объем линии, доступный для выборки", UnitOfMeasure.MLN_RUB, "availibleLineVolumeRub", false, Formats.NUMBER_FORMAT, null, true, true),
    ...
    CLOSE_PROBABILITY("Вероятность закрытия", UnitOfMeasure.PERCENT, "closeProbability", false, null, null, true, true),
    COMMISSION("Комиссия за выдачу", UnitOfMeasure.PERCENT, "comission", false, null, null, true, true);

    GridTopOtherItem(String description, String unitOfMeasure, String code, boolean _default, String numberFormat, String dateFormat,
                     boolean label) {
