...
/**
 * Remote interface for Enterprise Bean: DBFlexWorkflow
 */
public interface DBFlexWorkflow extends javax.ejb.EJBObject, DBFlexWorkflowCommon {
	 ...
	 * getAttributes
	 */
	public HashMap getAttributes(ArrayList params)
		throws java.rmi.RemoteException;
	...
	public java.lang.String loadSubProcessData(
		ArrayList paramsForLoadInVars,
		ArrayList paramsForLoadOutVars,
		ArrayList paramsForLoadMapRoles,
	 ...
	 * getProcessInfo
	 */
	public org.uit.director.db.dbobjects.WorkflowProcessInfo getProcessInfo(
		java.lang.Long long1) throws java.rmi.RemoteException;
	 ...
	 * callQuery
	 */
	public ArrayList callQuery(
		ArrayList params,
		java.lang.String nameProcedure,
		java.lang.String[] fields) throws java.rmi.RemoteException;
	...
	public java.lang.String[] assignToUser(
		...
		ArrayList param) throws java.rmi.RemoteException;
	...
	public ArrayList getWorkList(
		...
		java.lang.Integer typeList, ProcessSearchParam processSearchParame) throws java.rmi.RemoteException;
